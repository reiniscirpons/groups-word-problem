...
Proof.
  ...
  --- move/eqP: Hs => Hs.
      ...
      -!associativity (IH 0 H0q) Hs /b_encoding
  ...
  --- have HSs: (state.+1 < q)%N.
  ---- rewrite leq_eqVlt in Hstate; case/orP: Hstate Hs => [|//].
  ...
  --- move/eqP: Hs => Hs.
      ...
      (bool_irrelevance Hc (ltn_ord 1)).
  --- move/eqP: Hs => Hs. have HPs: (state.-1 < q)%N.
  ---- by rewrite ltnW => /=; case: state Hstate Hs.
  ---- rewrite morphism_preserve_law /=
      {1}/(\hat _) {1}/extension {1}/prod /=
      neutral_left -(neutral_left (inv _))
